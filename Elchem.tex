...
\def\author{Fabian Suter \\ Vorlage: Yves Looser, Nino Briker, Sandro Heidrich}  	% author(s)
...
\begin{document}
    \begin{layout}
        ...
        \input{Sections/01_Aufbau_der_Stoffe}
        \input{Sections/02_Stoffklassen}
        \input{Sections/03_Flüssigkristalle}
        \input{Sections/04_Ablauf chemischer Reaktionen}
        \input{Sections/05_Säure-Base-Reaktionen}
        \input{Sections/06_Redox-Reaktionen}
        \input{Sections/07_Anwendungen_Redox-Reaktionen}
        \input{Sections/08_Korrosion}
        
        \section{Emotional support meme}
        \begin{center}
            \includegraphics[width=0.8\columnwidth]{pictures/argon.jpeg} 
        \end{center}
