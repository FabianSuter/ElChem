...
\begin{tabular}{|l|c|c|}
		...
		\hline
		Van der Waals & \makecell{wirken zwischen allen Molekülen\\ (asymm. $e^-$-Verteilung, abh. Anzahl $e^-$)} &  \textcolor{red}{sehr schwach}\\
		\hline
		Dipol-Dipol & \makecell{ein permanenter Dipol (Polar und Asymmterisch)\\(Partialladung, $\delta^+, \delta^-$, $\Delta$EN)} & \textcolor{orange}{schwach} \\
		\hline
		Wasserstoffbrücken & freies Elektron vom H-Atom an N, O, F Atom gebunden & \textcolor{green!80!black}{stark} \\ 
		\hline
\end{tabular}%
}
